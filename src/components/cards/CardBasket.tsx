...
let [number,useNumber] = useState<number>(1)
  ...
  return (
    <div className='relative  z-0 w-[218px]'>
      <button className='absolute top-[10px] right-[10px] w-[36px] h-[32px] rounded-[10px] bg-grey_first shadow-[0_0_4px_0_#00000029]'>
        ...
        <div className=' rounded-[20px] border-2 px-[30px] py-[10px]'>
        <Image
        ...
        <p className='pt-[20px] font-[MullerBold]'>130500 сом</p>
        <p className='py-[16px] text-sm text-black'>IPhone 15 pro Natural Titanium 256 гб</p>
        <div>
