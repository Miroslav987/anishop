...
export default function Sorting() {
  ...
  return (
    <>
      <div className="pb-[20px] relative group/item">
        ...
        <div className="absolute group/edit invisible group-hover/item:visible top-[25px] py-[20px] px-[20px] z-10 rounded-[10px] bg-white shadow-shadow_first">
          <div className="flex flex-col gap-[10px]">
            <div className="flex gap-[5px]">
              <input id="up_price" name="sort" value="asc" onChange={(e) => handleSort(e.target.value)} type="radio" className="w-[18px]" />
              <label htmlFor="up_price" className="flex gap-[5px] text-sm">По возрастанию цены</label>
            </div>
            <div className="flex gap-[5px]">
              <input id="down_price" name="sort" value="desc" onChange={(e) => handleSort(e.target.value)} type="radio" className="w-[18px]" />
              <label htmlFor="down_price" className="flex gap-[5px] text-sm">По убыванию цены</label>
            </div>
            <div className="flex gap-[5px]">
              <input id="sale" name="sort" value="sale" onChange={(e) => handleSort(e.target.value)} type="radio" className="w-[18px]" />
