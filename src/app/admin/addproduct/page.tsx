...
export default function page() {
  ...
  const AddСharacteristicsChange = (indexProduct: number) => {
    ...
    updatedExtraProduct[indexProduct] = {
      ...updatedExtraProduct[indexProduct],
      characteristics: [...characteristics, characteristics[0]],
    };
                  ...
                  <div className="flex gap-[20px] items-center">
                    ...
                    <button
                      ...
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="#0000" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6.5 1.5H11.5M1.5 4H16.5M14.8333 4L14.2489 12.7661C14.1612 14.0813 14.1174 14.7389 13.8333 15.2375C13.5833 15.6765 13.206 16.0294 12.7514 16.2497C12.235 16.5 11.5759 16.5 10.2578 16.5H7.74221C6.42409 16.5 5.76503 16.5 5.24861 16.2497C4.79396 16.0294 4.41674 15.6765 4.16665 15.2375C3.88259 14.7389 3.83875 14.0813 3.75107 12.7661L3.16667 4" stroke="#e5e7eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </button>
                  </div>
                )}
