      ...
      <div className="mt-[50px] flex justify-between gap-[40px] ">
        ...
        <div className="w-full flex items-start  justify-between  mb-[50px] ">
          <div className="flex gap-[16px] items-center">
            ...
            <path d="M8.85719 10.1287C8.85719 11.8093 10.2643 13.1716 12.0001 13.1716C13.7358 13.1716 15.1429 11.8093 15.1429 10.1287C15.1429 8.44816 13.7358 7.0858 12.0001 7.0858C10.2643 7.0858 8.85719 8.44816 8.85719 10.1287Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            </div>
            <p className="text-xl" >Мои карты</p>
          </div>
