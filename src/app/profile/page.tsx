  ...
  return (
    <>
      <div className="flex gap-[30px] "> 
        <div onClick={()=>handleClick('/profile/my-address-creditcard')} 
        ...
        <div className="w-[50%] p-[20px] shadow-[0_0_6px_0_#0000001A] rounded-[10px]">
          ...
          <p className="text-lg font-[MullerBold]">+996 500 500 500</p>
        </div>
        <div className="w-[50%] p-[20px] shadow-[0_0_6px_0_#0000001A] rounded-[10px]">
          <p className="text-sm">Ваш кэшбек</p>
          <p className="text-lg font-[MullerBold]">25</p>
        </div>
      </div>
      <div className=" mt-[70px] flex gap-[16px] items-center">
        ...
        <div className="mt-[60px] flex gap-[20px] justify-end">
            ...
            <Link href={'/admin'} className="flex items-center justify-center gap-[8px] rounded-[10px] h-[60px] px-[100px] bg-white border-black border-2 ">
              <div>
