(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@firebase_firestore_dist_lite_index_browser_esm2017_a899bf.js", {

"[project]/node_modules/@firebase/firestore/dist/lite/index.browser.esm2017.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const f = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"]("@firebase/firestore");
/**
...
function __PRIVATE_logDebug(t, ...e) {
    if (f.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].DEBUG) {
        const r = e.map(__PRIVATE_argToString);
        f.debug(`Firestore (${d}): ${t}`, ...r);
    }
}
function __PRIVATE_logError(t, ...e) {
    if (f.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].ERROR) {
        const r = e.map(__PRIVATE_argToString);
 ...
 */ function __PRIVATE_logWarn(t, ...e) {
    if (f.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].WARN) {
        const r = e.map(__PRIVATE_argToString);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /** Formats an object as a JSON string, suitable for logging. */ return function __PRIVATE_formatJSON(t) {
 ...
 */ function __PRIVATE_debugCast(t, // eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    return t;
}
/**
 ...
 */ /** Returns a string describing the type / value of the provided input. */ function __PRIVATE_valueDescription(t) {
    ...
    if ("object" == typeof t) {
        ...
        {
            const e = /** try to get the constructor name for an object. */ function __PRIVATE_tryGetCustomObjectType(t) {
...
function __PRIVATE_cast(t, // eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
 ...
 */ class __PRIVATE_RestConnection {
    ...
    P(t, e, r, n, i) {
        ...
        return this.I(a, n, i), this.p(t, o, a, r).then((e)=>(__PRIVATE_logDebug("RestConnection", `Received RPC '${t}' ${s}: `, e), e), (e)=>{
 ...
 */ class __PRIVATE_AutoId {
    static newId() {
        ...
        for(; r.length < 20;){
            ...
            for(let i = 0; i < n.length; ++i)// Only accept values that are [0, maxMultiple), this ensures they can
    ...
    switch(r){
        ...
        case 2 /* TypeOrder.NumberValue */ :
            return function __PRIVATE_compareNumbers(t, e) {
                ...
                return r < n ? -1 : r > n ? 1 : r === n ? 0 : // one or both are NaN.
...
class SortedMap {
    ...
    indexOf(t) {
        ...
        for(; !r.isEmpty();){
            ...
            n < 0 ? r = r.left : (// Count all nodes left of the node plus the node itself
...
class SortedMapIterator {
    constructor(t, e, r, n){
        ...
        e && n && (i *= -1), i < 0) // This node is less than our start key. ignore it
 ...
 */ function __PRIVATE_queryNormalizedOrderBy(t) {
    ...
    if (null === e.S) {
        ...
        const r = e.explicitOrderBy.length > 0 ? e.explicitOrderBy[e.explicitOrderBy.length - 1].dir : "asc" /* Direction.ASCENDING */ , n = // Returns the sorted set of inequality filter fields used in this query.
 ...
 */ class __PRIVATE_ExponentialBackoff {
     ...
     */ r = 1e3, n = 1.5, i = 6e4){
        this.$ = t, this.timerId = e, this.L = r, this.M = n, this.k = i, this.U = 0, this.j = null, /** The last backoff attempt, as epoch milliseconds. */ this.W = Date.now(), this.reset();
    }
    /**
 ...
 */ class __PRIVATE_DatastoreImpl extends class Datastore {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */ P(t, e, r, n) {
        return this.Z(), Promise.all([
            this.authCredentials.getToken(),
            this.appCheckCredentials.getToken()
        ]).then(([i, s])=>this.connection.P(t, __PRIVATE_toResourcePath(e, r), n, i, s)).catch((t)=>{
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ g(t, e, r, n, i) {
        return this.Z(), Promise.all([
            this.authCredentials.getToken(),
            this.appCheckCredentials.getToken()
        ]).then(([s, o])=>this.connection.g(t, __PRIVATE_toResourcePath(e, r), n, s, o, i)).catch((t)=>{
            throw "FirebaseError" === t.name ? (t.code === p && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(A, t.toString());
        });
    }
    terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
    ...
    const i = __PRIVATE_debugCast(t), { request: s, X: o, parent: a } = function __PRIVATE_toRunAggregationQueryRequest(t, e, r, n) {
        ...
        const e = __PRIVATE_debugCast(t);
        return e.O || (// Do not include implicit order-bys for aggregate queries.
...
class Firestore {
    /** @hideconstructor */ constructor(t, e, r, n){
...
function initializeFirestore(t, e, r) {
    r || (r = "(default)");
    const n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(t, "firestore/lite");
...
function getFirestore(e, r) {
    const n = "object" == typeof e ? e : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])(), i = "string" == typeof e ? e : r || "(default)", s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(n, "firestore/lite").getImmediate({
        identifier: i
    });
    if (!s._initialized) {
        const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultEmulatorHostnameAndPort"])("firestore");
 ...
 */ function connectFirestoreEmulator(t, e, r, n = {}) {
    ...
    if ("firestore.googleapis.com" !== s.host && s.host !== o && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."), t._setSettings(Object.assign(Object.assign({}, s), {
        ...
        let e, r;
        if ("string" == typeof n.mockUserToken) e = n.mockUserToken, r = User.MOCK_USER;
        else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMockUserToken"])(n.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
 ...
 */ function terminate(t) {
    return t = __PRIVATE_cast(t, Firestore), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_removeServiceInstance"])(t.app, "firestore/lite"), t._delete();
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class AggregateQuerySnapshot {
    /** @hideconstructor */ constructor(t, e, r){
        this._userDataWriter = e, this._data = r, /** A type string to uniquely identify instances of this class. */ this.type = "AggregateQuerySnapshot", this.query = t;
    }
    /**
 ...
 */ class Query {
     ...
     */ e, r){
        this.converter = e, this._query = r, /** The type of this Firestore reference. */ this.type = "query", this.firestore = t;
    }
    withConverter(t) {
 ...
 */ class DocumentReference {
     ...
     * If provided, the `FirestoreDataConverter` associated with this instance.
     */ e, r){
        this.converter = e, this._key = r, /** The type of this Firestore reference. */ this.type = "document", this.firestore = t;
    }
    get _path() {
 ...
 */ class CollectionReference extends Query {
    /** @hideconstructor */ constructor(t, e, r){
        ...
        }(r)), this._path = r, /** The type of this Firestore reference. */ this.type = "collection";
    }
...
function collection(t, e, ...r) {
    if (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t), __PRIVATE_validateNonEmptyArgument("collection", "path", e), t instanceof Firestore) {
...
function doc(t, e, ...r) {
    if (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t), // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
 ...
 */ function refEqual(t, e) {
    return t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t), e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e), (t instanceof DocumentReference || t instanceof CollectionReference) && (e instanceof DocumentReference || e instanceof CollectionReference) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter;
}
/**
 ...
 */ function queryEqual(t, e) {
    return t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t), e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e), t instanceof Query && e instanceof Query && t.firestore === e.firestore && __PRIVATE_queryEquals(t._query, e._query) && t.converter === e.converter;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(t) {
        const e = __PRIVATE_createSentinelChildContext(this, t, /*array=*/ !0), r = this.dt.map((t)=>__PRIVATE_parseData(t, e)), n = new __PRIVATE_ArrayUnionTransformOperation(r);
        return new FieldTransform(t.path, n);
    }
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayUnionFieldValueImpl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this.dt, t.dt);
    }
}
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(t) {
        const e = __PRIVATE_createSentinelChildContext(this, t, /*array=*/ !0), r = this.dt.map((t)=>__PRIVATE_parseData(t, e)), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
        return new FieldTransform(t.path, n);
    }
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayRemoveFieldValueImpl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this.dt, t.dt);
    }
}
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(t, e, r, n, i, s) {
    const o = t.ht(1 /* UserDataSource.Update */ , e, r), a = [
        __PRIVATE_fieldPathFromArgument$1(e, n, r)
    ], u = [
        i
    ];
 ...
 */ function __PRIVATE_parseData(t, e) {
    ...
    // from firestore-exp.
    t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t))) return __PRIVATE_validatePlainObject("Unsupported field value:", e, t), __PRIVATE_parseObject(t, e);
    if (t instanceof FieldValue) // FieldValues usually parse into transforms (except deleteField())
 ...
 */ return function __PRIVATE_parseSentinelFieldValue(t, e) {
    ...
    return function __PRIVATE_parseScalarValue(t, e) {
        if (null === (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t))) return {
            nullValue: "NULL_VALUE"
        };
 ...
 */ function __PRIVATE_fieldPathFromArgument$1(t, e, r) {
    ...
    // FieldPath.
    e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e)) instanceof FieldPath) return e._internalPath;
 ...
 */ class DocumentSnapshot {
    ...
    /** @hideconstructor protected */ constructor(t, e, r, n, i){
 ...
 */ class QueryFieldFilterConstraint extends QueryConstraint {
     ...
     * @internal
     */ constructor(t, e, r){
        super(), this._field = t, this._op = e, this._value = r, /** The type of this query constraint */ this.type = "where";
    }
 ...
 */ class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(t) {
        ...
        return new Query(t.firestore, t.converter, function __PRIVATE_queryWithAddedOrderBy(t, e) {
            ...
            const r = t.explicitOrderBy.concat([
                e
            ]);
 ...
 */ class QueryLimitConstraint extends QueryConstraint {
    /**
     * @internal
     */ constructor(/** The type of this query constraint */ t, e, r){
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
    if (r[0] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(t, e, r, n, i) {
        ...
        // results.
        for (const r of __PRIVATE_queryNormalizedOrderBy(t))if (r.field.isKeyField()) s.push(__PRIVATE_refValue(e, n.key));
        else {
...
function __PRIVATE_parseDocumentIdValue(t, e, r) {
    if ("string" == typeof (r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(r))) {
 ...
 */ function __PRIVATE_validateNewFieldFilter(t, e) {
    ...
    if (null !== r) // Special case when it's a duplicate op to give a slightly clearer error message.
 ...
 */ function getDoc(t) {
    ...
    return __PRIVATE_invokeBatchGetDocumentsRpc(e, [
        t._key
    ]).then((e)=>{
...
function setDoc(t, e, r) {
    ...
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore(t.firestore), [
        i.toMutation(t._key, Precondition.none())
    ]);
}
function updateDoc(t, e, r, ...n) {
    ...
    // performing validation.
    let s;
    s = "string" == typeof (e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", t._key, e, r, n) : __PRIVATE_parseUpdateData(i, "updateDoc", t._key, e);
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore(t.firestore), [
        s.toMutation(t._key, Precondition.exists(!0))
    ]);
}
/**
 ...
 */ function deleteDoc(t) {
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore((t = __PRIVATE_cast(t, DocumentReference)).firestore), [
 ...
 */ function addDoc(t, e) {
    ...
    return __PRIVATE_invokeCommitRpc(__PRIVATE_getDatastore(t.firestore), [
        i.toMutation(r._key, Precondition.exists(!1))
    ]).then(()=>r);
}
/**
 * @license
 ...
 */ function aggregateQuerySnapshotEqual(t, e) {
    return queryEqual(t.query, e.query) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(t.data(), e.data());
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class WriteBatch {
    ...
    update(t, e, r, ...n) {
        ...
        // performing validation.
        let s;
        return s = "string" == typeof (e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", i._key, e, r, n) : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(s.toMutation(i._key, Precondition.exists(!0))), this;
    }
    /**
...
function __PRIVATE_validateReference(t, e) {
    if ((t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t)).firestore !== e) throw new FirestoreError(T, "Provided document reference is from a different Firestore instance.");
    return t;
}
/**
 ...
 */ class Transaction$1 {
    ...
    recordVersion(t) {
        ...
        if (r) {
            if (!e.isEqual(r)) // This transaction will fail no matter what.
     ...
     */ preconditionForUpdate(t) {
        ...
        if (!this.writtenDocs.has(t.toString()) && e) {
            if (e.isEqual(SnapshotVersion.min())) // The document doesn't exist, so fail the transaction.
 ...
 */ class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()){
        ...
        // be changed again.
        this.wt = !1, // Operations scheduled to be queued in the future. Operations are
        ...
        this.Dt = !1, // List of TimerIds to fast-forward delays for.
        this.bt = [], // Backoff timer used to schedule retries for retryable operations
        this.At = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */ ), // Visibility handler that triggers an immediate retry of all retryable
    ...
    enqueue(t) {
        if (this.Nt(), this.wt) // Return a Promise which never resolves.
        return new Promise(()=>{});
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /** Verifies whether `e` is an IndexedDbTransactionError. */ function __PRIVATE_isIndexedDbTransactionError(t) {
 ...
 */ function __PRIVATE_getMessageOrStack(t) {
     ...
     */ Lt(t) {
        ...
        return this.$t().then(()=>{
            ...
            /* eslint-disable-next-line @typescript-eslint/no-floating-promises */ this.gt.sort((t, e)=>t.targetTimeMs - e.targetTimeMs);
...
class Transaction {
    ...
    update(t, e, r, ...n) {
        ...
        // performing validation.
        let s;
        return s = "string" == typeof (e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", i._key, e, r, n) : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, s), this;
    }
    /**
     * Deletes the document referred to by the provided {@link DocumentReference}.
     *
 ...
 */ !function __PRIVATE_registerFirestore() {
    !function __PRIVATE_setSDKVersion(t) {
        d = t;
    }(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["SDK_VERSION"]}_lite`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_registerComponent"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$component$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"]("firestore/lite", (t, { instanceIdentifier: e, options: r })=>{
...
//# sourceMappingURL=node_modules_%40firebase_firestore_dist_lite_index_browser_esm2017_a899bf.js.map